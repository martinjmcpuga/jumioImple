...
const ExperienciaLaboral = () => {
  ...
  const customStyles = {
    control: (provided, state) => ({
      ...
      fontSize: '18px',
      borderRadius: '10px',
      borderColor: state.isFocused ? '#0078FF' : '#c4cbd1',
      boxShadow: state.isFocused ? '0 0 0 2px rgba(0, 120, 255, 0.3)' : 'none',
      '&:hover': {
        borderColor: '#0078FF',
      },
    }),
    option: (provided, state) => ({
      ...provided,
      backgroundColor: state.isSelected ? '#0078FF26' : '#fff',
      color: '#022500', // color del texto
      fontSize: '16px',
      padding: '10px 20px',
      cursor: 'pointer'
    }),
    ...
    singleValue: (provided) => ({
      ...provided,
      color: '#022500', // color del texto seleccionado
      fontSize: '18px',
    }),
  };
